...
function dropToken() {
	...
	TweenLite.to(".frame2", 0.5, { y: -207, delay: 2 });
...
function MoveX() {
	...
	if (theCount < 5) {
		updatetokenX();
		if (tokenX <= 9) {
			TweenLite.to(token, 0.8 * e, { rotation: "+=40", x: "+=29", ease: Bounce.easeOut });
...
function dropToDrink() {
	var e = 0.7;
	console.log(endX);
	if (endX >= -31 && endX <= -24) TweenLite.to(token, 0.3 * e, { y: 539 - offsetY, x: -37, onComplete: getRecipe, ease: Bounce.easeOut, delay: 0.3 * e });
	if (endX >= 26 && endX <= 32) TweenLite.to(token, 0.3 * e, { y: 539 - offsetY, x: 31, onComplete: getRecipe, ease: Bounce.easeOut, delay: 0.3 * e });
	if (endX >= 84 && endX <= 90) TweenLite.to(token, 0.3 * e, { y: 539 - offsetY, x: 90, onComplete: getRecipe, ease: Bounce.easeOut, delay: 0.3 * e });
	if (endX >= 140 && endX <= 149) TweenLite.to(token, 0.3 * e, { y: 539 - offsetY, x: 155, onComplete: getRecipe, ease: Bounce.easeOut, delay: 0.3 * e });
}
...
function getRecipe() {
	updatetokenX();
	if (tokenX < 50) {
		TweenLite.to(recipe1, 0.5, { alpha: 1, delay: 1 });
	...
	if (tokenX >= 50 && tokenX < 119) {
		...
		TweenLite.to(recipe2, 0.5, { alpha: 1, delay: 1 });
	}
	if (tokenX >= 119 && tokenX < 179) {
		TweenLite.to(shadow4, 0.5, { alpha: 0.45, delay: 0.2 });
		TweenLite.to(shadow1, 0.5, { alpha: 0.45, delay: 0.2 });
		TweenLite.to(shadow2, 0.5, { alpha: 0.45, delay: 0.2 });
		TweenLite.to(recipe3, 0.5, { alpha: 1, delay: 1 });
	}
	if (tokenX >= 179) {
		TweenLite.to(shadow1, 0.5, { alpha: 0.45, delay: 0.2 });
		TweenLite.to(shadow2, 0.5, { alpha: 0.45, delay: 0.2 });
		TweenLite.to(shadow3, 0.5, { alpha: 0.45, delay: 0.2 });
		TweenLite.to(recipe4, 0.5, { alpha: 1, delay: 1 });
	}
	TweenLite.to(token, 0.5, { alpha: 0, delay: 1 });
	TweenLite.to(playBTN, 1, { alpha: 1, delay: 1 });
	TweenLite.to(recipeBTN, 1, { alpha: 1, delay: 1 });
...
function replay() {
	...
	TweenLite.to(".frame2", 0.8, { y: 0, delay: 0.15 });
	...
	TweenLite.to(replayBTN, 0.15, { alpha: 0 });
...
(function() {
	...
	maintl
		...
		.from(".meticulously-crafted", 0.5, { autoAlpha: 0 }, "frame0+=.5")
		.from(".stamp", 0.5, { autoAlpha: 0, scale: 0.8, rotation: "+=25" }, "frame0+=.9")
		.add("frame1", "+=2")
...
setTimeout(function() {
	if (!hasInteracted) TweenLite.to(token, 0.5, { y: 150 - offsetY, onComplete: dropToken });
}, autoPlayStart);
var theCount = 0;
